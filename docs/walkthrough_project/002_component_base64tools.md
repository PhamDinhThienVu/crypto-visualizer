# Tạo component nhập và xử lý base64 với Vue

## 1. Tạo component nhập và xử lý Base64
Trong frontend/src/components/, tạo file Base64Tool.vue:
